...
const apiClient = {
  ...
  fetchBoardById: function (id, callback) {
    return axios
  ...
  updateCard: function (id, updates, callback) {
    return axios
      .put(routes.UPDATE_CARD_URL + `/${id}`, updates)
      .then(unwrapData)
      .then(callback)
      .catch(logError)
  },
  createComment: function (id, comment, callback) {
    return axios
      .post(routes.CREATE_COMMENT_URL + `/${id}`, comment)
      .then(unwrapData)
      .then(callback)
      .catch(logError)
  }
